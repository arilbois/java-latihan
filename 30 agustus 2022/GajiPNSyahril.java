...
public class GajiPNSyahril{
	...
	public static void main(String[] args){
		...
		if (golonganPangkat == 1){
			gajiPokok = menghitungGajiPokok(GAJIPOKOKGOLONAN,golonganPangkat,masakerja,convertedRuangKerja);			
		}else if (golonganPangkat == 2){
			gajiPokok = menghitungGajiPokok(GAJIPOKOKGOLONAN,golonganPangkat,masakerja,convertedRuangKerja);			
	...
	public static double menghitungGajiPokok(int[][][] gajiPokokGolongan,int golonganPangkat ,int masakerja,int convertedRuangKerja){
