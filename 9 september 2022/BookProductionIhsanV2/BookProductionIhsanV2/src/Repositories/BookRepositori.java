...
public class BookRepositori {
    ...
    public List<Book> getAllBook(){
        ...
        //object customer
        Customers customer16 = new Customers("Devis", "Destian", "Indonesia", "Laki-Laki", "Garut", "0823241232", "44191", "devis@yahoo.com");
        Customers customer17 = new Customers("Aditya", "Mauludin", "Indonesia", "Laki-Laki", "Garut", "089241872", "44191", "adityam@gmail.com");
        Customers customer18 = new Customers("Indra", "Athalla", "Indonesia", "Laki-Laki", "Bandung", "0833681238", "40111", "Athalla_i@live.com");
        Customers customer19 = new Customers("Fira", "Febriani", "Indonesia", "Perempuan", "Bekasi", "082194222", "13175", "fira_28@yahoo.com");
        Customers customer20 = new Customers("Resa", "Maldini", "Indonesia", "Perempuan", "Tanggerang", "0829200122", "12260", "resam_99@outlook.com");
        ...
        Customers customer6 = new Customers("Ficko", "Azhar", "Indonesia", "Male", "Cilacap", "081678673928", "53245", "ficko@gmail.com");
        Customers customer7 = new Customers("Adelia", "Mawardhi", "Indonesia", "Female", "Purwokerto", "08178439382", "56321", "adelia@gmail.com");
        Customers customer8 = new Customers("Narcisco", "ryan", "Columbia", "Male", "Bogota", "087839273892", "53324", "narcisco@gmail.com");
        Customers customer9 = new Customers("Sofia", "rahmadani", "Indonesia", "Female", "Kutai", "081783748209", "53819", "sofia@gmail.com");
        Customers customer10 = new Customers("Dimas", "didan", "Indonesia", "Male", "Yogyakarta", "081903948293", "09498", "dimas@gmail.com");
        ...
        // from bukuonlinestore.com, isverified random
        ...
        // name from tokopedia. email, phone number, address, postalcode, email random.
        Customers surya = new Customers("Surya", "Iman", "Indonesia", "Male", "Bogor", "081384098351", "16610", "suryaiman@gmail.com");
        Customers melissa = new Customers("Melissa", "Anggari", "Indonesia", "Female", "Jakarta", "089344905769", "16115", "melissaanggari@gmail.com");
        Customers karolina = new Customers("Carolina", "Angela", "Indonesia", "Female", "Depok", "089944325589", "18445", "carolinaangela@gmail.com");
        Customers arvi = new Customers("Arvi", "Andhika", "Indonesia", "Male", "Bekasi", "094455882233", "13550", "arviandhika@gmail.com");
        Customers henzie = new Customers("Henzie", "Sulistia", "Indonesia", "Female", "Banten", "083355890139", "14189", "henziesulistia@gmail.com");
