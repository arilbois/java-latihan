	...
	public static void main( String[] args){
		...
		if(passenger > 120){
			...
			if(passenger <= 120 && passenger > 105){
				...
				System.out.println("* Recommended bus for you \n- 2 buses with 60 seats at a price of " + 2 * busP60);
			}else if(passenger <= 105 && passenger > 92){
				System.out.println(bus60);

				System.out.println("* Recommended bus for you \n- 1 bus with 60 seats and 1 bus with 45 seats with a price of "+ (busP60+busP45));
			}else if(passenger <= 92 && passenger > 90){
				System.out.println(bus60);

				System.out.println("* Recommended bus for you \n- 1 bus with 60 seats and 1 bus with 32 seats with a price of "+ (busP60+busP32));
			}else if(passenger <= 90 && passenger > 78){
				System.out.println(bus60);

				System.out.println("* Recommended bus for you \n-2 buses with 45 seats at a price of " + 2 * busP45);
			}else if(passenger <= 78  && passenger > 72){
				System.out.println(bus60);

				System.out.println("* Recommended bus for you \n- 1 bus with 60 seats and 1 bus with 18 seats with a price of "+ (busP60+busP18));
			}else if(passenger <= 72  && passenger > 63){
				System.out.println(bus60);

				System.out.println("* Recommended bus for you \n- 1 bus with 60 seats and 1 bus with 12 seats with a price of "+ (busP60+busP12));
			}else if(passenger <= 63  && passenger > 61){
				System.out.println(bus60);

				System.out.println("* Recommended bus for you \n- 1 bus with 45 seats and 1 bus with 18 seats with a price of "+ (busP45+busP18));
			}else if(passenger == 60 ){
				System.out.println(bus60);

				System.out.println("* Recommended bus for you \n- 1 buses with 60 seats at a price of " + busP60);
				...
				System.out.println("* Recommended bus for you \n- 1 bus with 45 seats and 1 bus with 12 seats with a price of "+ (busP45+busP12));
			}else if(passenger == 45 ){
				System.out.println(bus45);

				System.out.println("* Recommended bus for you \n- 1 buses with 45 seats at a price of " + busP45);
			}else if(passenger <= 44  && passenger > 36 ){
				System.out.println(bus32);

				System.out.println("* Recommended bus for you \n- 1 bus with 32 seats and 1 bus with 12 seats with a price of "+ (busP32+busP12));
			}else if(passenger <= 35  && passenger > 33 ){
				System.out.println(bus32);

				System.out.println("* Recommended bus for you \n- 2 buses with 18 seats at a price of " + 2 * busP18);
			}else if(passenger == 32 ){
				System.out.println(bus32);

				System.out.println("* Recommended bus for you \n- 1 buses with 18 seats at a price of " + 1 * busP32);
				...
				System.out.println("* Recommended bus for you \n- 1 bus with 18 seats and 1 bus with 12 seats with a price of "+ (busP18+busP12));
			}else if(passenger <=24  && passenger > 18 ){
				System.out.println(bus18);

				System.out.println("* Recommended bus for you \n- 2 buses with 12 seats at a price of " + 2 * busP12);
			}else if(passenger == 18 ){
				System.out.println(bus18);

				System.out.println("* Recommended bus for you \n- 1 buses with 18 seats at a price of " + busP18);
				...
				System.out.println("* Recommended bus for you \n- 1 buses with 12 seats at a price of " + busP12);
			}else if(passenger <=11  && passenger > 6 ){
				System.out.println(bus6);

				System.out.println("* Recommended bus for you \n- 2 buses with 6 seats at a price of " + 2 * busP6);
			}else if(passenger <=6  && passenger > 0 ){
				System.out.println(bus6);

				System.out.println("* Recommended bus for you \n- 1 buses with 6 seats at a price of " + 1 * busP6);
			}else{
