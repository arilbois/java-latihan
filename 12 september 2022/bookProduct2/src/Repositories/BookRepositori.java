...
public class BookRepositori {
        ...
        public static Map<String, Object> getAllBookAndRating() {
                ...
                Publisher gramedia = new Publisher("Gramedia Pustaka", "Indonesia", paper21);
                Publisher grasindo = new Publisher("Grasindo", "Indonesia", paper22);
                Publisher erlangga = new Publisher("Erlangga", "Indonesia", paper23);
                Publisher mizan = new Publisher("Mizan Pustaka", "Indonesia", paper24);
                Publisher republika = new Publisher("Penerbit Republika", "Indonesia", paper25);
                ...
                Book book14 = new Book("Words Kids Need to Read", "1 January 2002", author14, publisher14);
                ...
                listPaper = new ArrayList<Paper>(Arrays.asList(paper1, paper2, paper3, paper4, paper5, paper6, paper7,
                                paper8, paper9, paper10, paper11, paper12, paper13, paper14,
                                paper15, paper16, paper17, paper18, paper19, paper20, paper21, paper22, paper23,
                                paper24, paper25));
