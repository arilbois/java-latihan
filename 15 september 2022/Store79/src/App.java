                ...
                case 1:
                    ...
                    switch (choiseMenu) {
                        case 1:
                            ...
                            System.out.println("MASUKAN PRODUCTT ID");
                            String productId = Validations.INPUT.nextLine();
                            System.out.println("MASUKAN QTY");
                            int qty = Validations.inputTypeNumberLimit("", 0, 199);
                            CartList.prosesCartList(productId);
                            // sCartShop.getCartShopTable();
                            break;
                        case 2:
