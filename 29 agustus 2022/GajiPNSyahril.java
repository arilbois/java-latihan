...
public class GajiPNSyahril{
	public static final Scanner INPUT = new Scanner(System.in);

	public static final String
	TEMPLATEINPUTNAMA = "Tolong Masukan Nama Anda :",TEMPLATEINPUTGOLONGAN = "Tolong Masukan Golongan Anda :",TEMPLATEINPUTRUANGKERJA = "Tolong Masukan Golongan Ruang Kerja Anda :",
	TEMPLATEINPUTMASAKERJA = "Tolong Masukan Jumlah Masa Kerja Golongan Anda :",TEMPLATEINPUTSTATUSMENIKAH = "Tolong Masukan Status Menikah Anda : (Kawin/Belum Kawin/Cerai) )",TEMPLATEINPUTJUMLAHANAK = "Tolong Masukan Jumlah Anak Anda :",
	REGEX = "[0-9]+",TEMPLATEWELCOME = "Slip Gaji Karyawan", TEMPLATEINPUTGOLONGAN12 = "Hanya ada Golongan Ruang Kerja A",
	TEMPLATELINE = "=================================================";

	public static final int 
	MINIMALPANGKAT = 1, MAXIMALPANGKAT = 4,MINIMALANAK = 0,MINIMALMASAKERJA = 0,  MAXIMALDATA = 33, MAXIMALGOLONGAN1 = 2, MAXIMALMASAKERJAGOLONGAN1 = 27, MAXIMALMASAKERJAGOLONGAN2 = 33, MAXIMALMASAKERJAGOLONGAN34 = 32 ;
	...
	public static void main(String[] args){
		...
		double[] potonganTaperumData = {3000,5000,7000,10000}, tunjaganJabatanData = {175000,180000,185000,190000};
		...
		//Input Masa kerja
			if(golonganPangkat == 1){
				masakerja = inputTypeNumberLimit(TEMPLATEINPUTMASAKERJA, MINIMALMASAKERJA, MAXIMALMASAKERJAGOLONGAN1);
			}else if(golonganPangkat == 2){
				masakerja = inputTypeNumberLimit(TEMPLATEINPUTMASAKERJA, MINIMALMASAKERJA, MAXIMALMASAKERJAGOLONGAN2);
			}else{
				masakerja = inputTypeNumberLimit(TEMPLATEINPUTMASAKERJA, MINIMALMASAKERJA, MAXIMALMASAKERJAGOLONGAN34);
			}
		...
		if (golonganPangkat == 1){
			gajiPokok = menghitungGajiPokok(GAJIPOKOKGOLONAN1,masakerja,convertedRuangKerja);			
		}else if (golonganPangkat == 2){
			gajiPokok = menghitungGajiPokok(GAJIPOKOKGOLONAN2,masakerja,convertedRuangKerja);			
		}else if (golonganPangkat == 3){
			gajiPokok = menghitungGajiPokok(GAJIPOKOKGOLONAN3,masakerja,convertedRuangKerja);			
		}else{
			gajiPokok = menghitungGajiPokok(GAJIPOKOKGOLONAN4,masakerja,convertedRuangKerja);			
		}
		...
		tunjaganJabatan = menghitungData(golonganPangkat, tunjaganJabatanData);
		...
		potonganTaperum = menghitungData(golonganPangkat, potonganTaperumData);
		...
		System.out.println("Tunjangan Istri               :"+indonesiaCurrency(tunjanganKeluarga));
		System.out.println("Tunjangan Anak                :"+indonesiaCurrency(tunjanganAnak));
		System.out.println("Tunjangan Jabatan             :"+indonesiaCurrency(tunjaganJabatan));
		System.out.println("Tunjangan beras               :"+indonesiaCurrency(tunjanganBeras));
		System.out.println(TEMPLATELINE);
		System.out.println("jumlah Pengahasilan Bruto     :"+indonesiaCurrency(gajiBruto));
		System.out.println(TEMPLATELINE);
		System.out.println("jumlah Potongan PPH 21        :"+indonesiaCurrency(potonganPph));
		System.out.println("jumlah Potongan IWP           :"+indonesiaCurrency(iuaranWajibPajak));
		System.out.println("jumlah Potongan Taperum       :"+indonesiaCurrency(potonganTaperum));
		System.out.println(TEMPLATELINE);
		System.out.println("Total Potongan                :"+indonesiaCurrency(totalPotongan));	
		System.out.println(TEMPLATELINE);
		System.out.println("jumlah Gaji Neto / THP        :"+indonesiaCurrency(gajiNeto));
		System.out.println(TEMPLATELINE);
	}//batas main
	...
	public static int convertGolonganRuangKerja(String golonganRuangKerja){
		int convertedRuangKerja; 
		if (golonganRuangKerja.equalsIgnoreCase("A")){
			convertedRuangKerja = 0;
		}else if (golonganRuangKerja.equalsIgnoreCase("B")){
			convertedRuangKerja = 1;
		}else if (golonganRuangKerja.equalsIgnoreCase("C")){
			convertedRuangKerja = 2;
		}else if (golonganRuangKerja.equalsIgnoreCase("D")){
			convertedRuangKerja = 3;
		}else{
			convertedRuangKerja = 4;
		}
		return convertedRuangKerja;
	}
	//Function untuk Menghitung gaji Pokok
	public static double menghitungGajiPokok(int[][] gajiPokokGolongan,int masakerja,int convertedRuangKerja){
		double gajiPokok = gajiPokokGolongan[masakerja][convertedRuangKerja];
		return gajiPokok;
	}
	...
	public static double menghitungTunjangan(double gajiPokok,String statusPernikahan){
		double tunjanganKeluarga, gajiPokokPercent = 0.1;
	...
	public static double menghitungTunjangan(int jumlahAnak,String statusPernikahan){
		jumlahAnak = maximalAnak(jumlahAnak);
		double tunjanganBeras, hargaBeras = 15000, banyakBeras = 10;
		if (statusPernikahan.equalsIgnoreCase("kawin")){
			tunjanganBeras = (2 + jumlahAnak) * hargaBeras * banyakBeras;	
		}else if (statusPernikahan.equalsIgnoreCase("Cerai")){
			tunjanganBeras = (1 + jumlahAnak) * hargaBeras * banyakBeras;	
		}else{
			tunjanganBeras = 1 * hargaBeras * banyakBeras;	
		}
		return tunjanganBeras;
	}
	//Function untuk Menghitung Tunjangan Jabatan
	public static double menghitungData(int golonganPangkat, double[] data){
		double valueData; 
		if (golonganPangkat == 1){
			valueData = data[0];
		}else if (golonganPangkat == 2){
	...
	public static double menghitungPotongan(double netto, String statusPernikahan, double jumlahAnak){
		double wpSendiri= 36000000, wpAnak= 0, wpistri = 0, pphSetahunPercen = 0.05, setahun = 12;
		if (statusPernikahan.equalsIgnoreCase("kawin")){
			wpistri =  3000000;
		}
		if (jumlahAnak > MINIMALANAK){
			wpAnak = jumlahAnak * 3000000;
		}
